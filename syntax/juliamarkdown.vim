" Vim syntax file
" Language:     Julia Markdown (as used by Weave.jl)
" Filenames:    *.jmd
"
" Lightly adapted from Tim Pope's 29 Aug 2016 markdown syntax file.
...
syn region markdownCode matchgroup=markdownCodeDelimiter start="^\s*```julia.*$" end="^\s*```\ze\s*$" keepend contains=@Julia
