...
syntax match    juliaIndexableCollections    display "\<\%(getindex\|setindex!\|firstindex\|lastindex\)\>"
...
syntax match    juliaMathematicalFunctions    display "\<\%(isapprox\|sin\|cos\|sincos\|tan\|sind\|cosd\|tand\|sinpi\|cospi\|sincospi\|sinh\|cosh\|tanh\|asin\|acos\|atan\|asind\|acosd\|atand\|sec\|csc\|cot\|secd\|cscd\|cotd\|asec\|acsc\|acot\|asecd\|acscd\|acotd\|sech\|csch\|coth\|asinh\|acosh\|atanh\|asech\|acsch\|acoth\|sinc\|cosc\|deg2rad\|rad2deg\|hypot\|log\|log\|log2\|log10\|log1p\|frexp\|exp\|exp2\|exp10\|ldexp\|modf\|expm1\|round\|RoundingMode\|RoundNearest\|RoundNearestTiesAway\|RoundNearestTiesUp\|RoundToZero\|RoundFromZero\|RoundUp\|RoundDown\|round\|ceil\|floor\|trunc\|unsafe_trunc\|min\|max\|minmax\|clamp\|clamp!\|abs\|checked_abs\|checked_neg\|checked_add\|checked_sub\|checked_mul\|checked_div\|checked_rem\|checked_fld\|checked_mod\|checked_cld\|add_with_overflow\|sub_with_overflow\|mul_with_overflow\|abs2\|copysign\|sign\|signbit\|flipsign\|sqrt\|isqrt\|cbrt\|real\|imag\|reim\|conj\|angle\|cis\|cispi\|binomial\|factorial\|gcd\|lcm\|gcdx\|ispow2\|nextpow\|prevpow\|nextprod\|invmod\|powermod\|ndigits\|widemul\|evalpoly\|@evalpoly\|@fastmath\)\>"
