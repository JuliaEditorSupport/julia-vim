...
" exec 'syntax match   juliaFunctionName	contained "\(\<function\s\+\)\@'.s:d(15).'<=[^(;[:space:]]\+"'
...
exec 'syntax match   juliaFunctionName	contained "\(\<function\s\+\)\@'.s:d(15).'<=' . s:idregex . '\%(\.' . s:idregex . '\)*"'
